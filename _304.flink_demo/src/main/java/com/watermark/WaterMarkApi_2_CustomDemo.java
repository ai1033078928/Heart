...
public class WaterMarkApi_2_CustomDemo {
    /**
     *
     */
    ...
    public static void main(String[] args) throws Exception {
        ...
        WatermarkStrategy<User> watermarkStrategy = WatermarkStrategy
                ...
                .<User>forGenerator(
                        // TODO 使用自定义的生成器
                        new WatermarkGeneratorSupplier<User>() {
                            @Override
                            public WatermarkGenerator<User> createWatermarkGenerator(Context context) {
                                return new MyWaterMarkGenerator<>(3000L);
                            }
                        }
                )
                // 1.2 指定时间戳分配器，从数据中提取
