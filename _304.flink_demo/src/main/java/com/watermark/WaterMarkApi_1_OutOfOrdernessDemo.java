...
public class WaterMarkApi_1_OutOfOrdernessDemo {
    /**
     * TODO 内置watermark的生成原理
     * 1.都是周期性生成的  默认200ms  env.getConfig().setAutoWatermarkInterval(200);
     * 2. 有序流：watermark = 当前最大的事件事件 - 1ms
     * 3. 乱序流：watermark = 当前最大的事件事件 - 延迟时间 - 1ms
     */
